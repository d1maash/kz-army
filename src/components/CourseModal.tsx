...
interface CourseModalProps {
  card: {
    ...
    learnItems: { title: string; description: string }[]
  }
  onClose: () => void
}

const CourseModal: FC<CourseModalProps> = ({ card, onClose }) => {
  return (
    <div 
      ...
      >
        ...
        <div className="p-6 flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-4">
            <h2 className="font-bold text-xl">Чему вы научитесь?</h2>
            <ul className="flex flex-col gap-4">
              {card.learnItems.map((item, index) => (
          ...
          <div className="flex flex-col gap-4">
            <h2 className="font-bold text-xl">Преимущества обучения</h2>
